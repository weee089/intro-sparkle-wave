                ...
                <div className="relative bg-card/80 backdrop-blur-xl rounded-xl border border-border shadow-2xl">
                    ...
                    <div className="flex items-center justify-between p-3 border-t border-border/50">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                type="button"
                                className="px-2 py-1 rounded-lg text-sm text-muted-foreground transition-colors border border-dashed border-border hover:border-primary hover:bg-accent/50 flex items-center justify-between gap-1"
                            >
...
function ActionButton({ icon, label }: ActionButtonProps) {
    return (
        <button
            type="button"
            className="flex items-center gap-2 px-4 py-2 bg-card/60 hover:bg-card/80 backdrop-blur-sm rounded-full border border-border text-muted-foreground hover:text-foreground hover:border-primary/50 transition-all shadow-sm hover:shadow-md"
        >
            {icon}
