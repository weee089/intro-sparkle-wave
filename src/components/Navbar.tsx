...
export default function Navbar() {
  ...
  return <>
      ...
      y: 0
    }} className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300", isScrolled ? "bg-slate-950/60 backdrop-blur-xl shadow-lg border-b border-white/10" : "bg-slate-950/30 backdrop-blur-md border-b border-white/5")}>
